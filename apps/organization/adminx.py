...
class CourseOrgAdmin(object):
    list_display = ['name', 'desc', 'click_num', 'image', 'address', 'city', 'add_time']
    search_fields = ['name', 'desc', 'click_num', 'image', 'address', 'city']
    list_filter = ['name', 'desc', 'click_num', 'image', 'address', 'city', 'add_time']
